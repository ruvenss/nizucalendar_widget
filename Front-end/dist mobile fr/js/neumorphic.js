$(document).ready(function () {
    ...
    dropdown.append('<option selected="true" disabled>Choissisez votre pays</option>');
    dropdown.prop('selectedIndex', 0);

    dropdown_guest.append('<option selected="true" disabled>Choissisez votre pays</option>');
